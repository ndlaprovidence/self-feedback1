...
final class Version20220329101022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, DEFAULT NULL, note_date DATE NOT NULL, INDEX IDX_B723AF338F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE student_critere (id INT AUTO_INCREMENT NOT NULL, id_student_id INT NOT NULL, id_critere_id INT NOT NULL, INDEX IDX_925C35AB6E1ECFCD (id_student_id), INDEX IDX_925C35AB3BD5C57C (id_critere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
