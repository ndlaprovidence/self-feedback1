...
class ExportController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        function setGraphTemplate(\TCPDF $pdf)
        ...
        function insertIntoGraph(\TCPDF $pdf)
        ...
        function coordTranslator(float $note)
        { //Traduit les notes en coordonnée Y pour le graphique.
            return 155 - (100 * ($note - 1) * 25 / 100);
        }
        function getData(\TCPDF $pdf, $request, bool $refuse = false)
        { //ça a commencé en getdata, et ça finit en postdata lmao
            $bidule = 0;
