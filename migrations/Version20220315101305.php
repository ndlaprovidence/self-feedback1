 ...
 */
final class Version20220315101305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, note_repas SMALLINT NOT NULL, note_valeur_environnement SMALLINT NOT NULL, note_commentaire VARCHAR(1000) DEFAULT NULL, note_date DATE NOT NULL, note_chaleur SMALLINT NOT NULL, note_gout SMALLINT NOT NULL, INDEX IDX_B723AF338F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
