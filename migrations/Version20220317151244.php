 ...
 */
final class Version20220317151244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, note_commentaire VARCHAR(1000) DEFAULT NULL, note_date DATE NOT NULL, note_chaleur SMALLINT NOT NULL, note_gout SMALLINT NOT NULL, notequantite SMALLINT NOT NULL, noteacceuil SMALLINT NOT NULL, notediversite SMALLINT NOT NULL, notehygiene SMALLINT NOT NULL, INDEX IDX_B723AF338F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
